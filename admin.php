...
if(!empty($_POST) && isset($_POST) && isset($_POST['instructor']) && isset($_POST['types'])) {
    ...
    if(is_numeric($year)& is_numeric($month)& is_numeric($day)& is_numeric($spots)) {
...
?>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#fullpage').fullpage({
                sectionsColor: ['#FFDCF4', '#4BBFC3', '#7BAABE', 'red'],
    ...
    <div id="fullpage">
        ...
        <div class="section" id="section0">
                <div class="container">
                    ...
                    <div class="content">
           <li class="dropdown">
        <h1>Hi, welcome to the Admin page!</h1>
        <p>You can create an event by clicking on "Create Event" or edit an existing event by clicking on the "Edit Events" button</p>
              
                    <form id="login-form">
                        
                        <input type="button" class="admin-btns" id="create" value="Create Event" style="cursor:pointer" onclick="document.getElementById('modal').style.display='block'">
                        <a class="admin-btns" id="create" href="admin/event.php" style="cursor:pointer">Edit Events</a>
                    </form>
            </li>
        </ul>
    ...
    <div id="modal" class="modal">
        <div class="modal-content animate">s
